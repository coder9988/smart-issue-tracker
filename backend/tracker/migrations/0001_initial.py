    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('developer', 'Developer'), ('reporter', 'Reporter')], default='reporter', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('bug', 'Bug'), ('feature', 'Feature'), ('task', 'Task'), ('other', 'Other')], default='other', max_length=20)),
